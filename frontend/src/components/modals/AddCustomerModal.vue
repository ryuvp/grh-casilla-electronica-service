    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header" id="kt_modal_add_customer_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold">Agregar Cliente</h2>
          <!--end::Modal title-->
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            >
              ...
              <div class="fv-row mb-7">
                ...
                <label class="fs-6 fw-semibold mb-2">
                  ...
                  <i
                    ...
                    title="El correo debe estar activo"
                  ></i>
                </label>
                <!--end::Label-->
              ...
              >
                ...
                <div class="d-flex flex-column mb-7 fv-row">
                  <!--begin::Label-->
                  <label class="fs-6 fw-semibold mb-2">Dirección línea 2</label>
                  <!--end::Label-->
                ...
                <div class="d-flex flex-column mb-7 fv-row">
                  ...
                  <el-select v-model="formData.country">
                    <el-option value="">Selecciona un país...</el-option>
                    <el-option
                  ...
                  <div class="d-flex flex-stack">
                    ...
                    <div class="me-5">
                      ...
                      <label class="fs-6 fw-semibold"
                        >¿Usar como dirección de facturación?</label
                      >
                      <!--end::Label-->
